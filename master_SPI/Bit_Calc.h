...
/****************PIN calculation****************/
#define BITCALC_SET_BIT(REG,BIT_NUM)	  			((REG) |= (1<<(BIT_NUM)))
#define BITCALC_CLR_BIT(REG,BIT_NUM) 		  		((REG) &= ~(1<<(BIT_NUM)))
#define BITCALC_TOGGLE_BIT(REG,BIT_NUM) 			((REG) ^= (1<<(BIT_NUM)))
#define BITCALC_GET_BIT(REG,BIT_NUM) 			    (!!((REG) &(1<<(BIT_NUM))))
